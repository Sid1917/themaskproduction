...
const stats = [
  { value: '250+', label: 'Events Produced', sub: 'and counting' },
  { value: '8', label: 'Years Experience', sub: 'since 2017' },
  { value: '20', label: 'Cities Covered', sub: 'across India' },
  { value: '95%', label: 'Repeat Clients', sub: 'brands that return' },
]

export default function EventsStatsBar() {
